...
CUDA_VISIBLE_DEVICES=0 python examples/domain_adaptation/image_classification/mdd.py data/optical-isar -d Optical_ISAR -s o -t i --arch resnet50 --epochs 5 --iters-per-epoch 100 --pretrain logs/mdd/optical-isar/checkpoints/latest.pth --seed 1 --log logs/mdd/optical-isar