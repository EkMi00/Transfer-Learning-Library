...
CUDA_VISIBLE_DEVICES=0 python examples/domain_adaptation/image_classification/mdd.py data/optical-isar -d Optical_ISAR -s o -t i --arch resnet50 --epochs 10 --batch-size 32 --iters-per-epoch 100 --print-freq 10 --log logs/mdd/optical-isar --pretrain logs/mdd/optical-isar/checkpoints/latest.pth