...
CUDA_VISIBLE_DEVICES=0 python examples/domain_adaptation/image_classification/mdd.py data/optical-isar -d Optical_ISAR -s o -t i --arch resnet50 --epochs 50 --iters-per-epoch 100 --log logs/mdd/optical-isar